...
The DocumentWriter in daq-storage automatically subscribes to document streams and writes to disk when enabled in daemon configuration. The daemon must be started with DocumentWriter active for auto-save to work. This is configured via:
